    ...
    <div id="my-order">
        ...
        <form>
            <div id="order-info" class="flex flex-col xl:flex-row gap-6">          
                <div id="order-customer-info" class="bg-white rounded p-4 w-full xl:w-1/2 order-2 xl:order-1">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            ...
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-street">
                                ...
                                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-street" type="text" placeholder="Street address">
                            </div>
                            <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-unit">
                                Unit #
                            </label>
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-unit" type="text" placeholder="Unit">
                            </div>
                        </div>
                ...
                <div id="order-items" class="bg-white rounded p-4 w-full xl:w-1/2">
                    ...
                    <div v-for="product in cartProducts" class="order-item flex items-center border-b border-[#2222221a] pb-[15px] mb-[15px]">
                        ...
                        <div class="ml-[15px] flex flex-row justify-end w-6/12">
                            <div class="relative flex items-center max-w-[8rem]">
                                <button type="button" id="decrement-button" data-input-counter-decrement="quantity-input" class="bg-gray-100 hover:bg-gray-200 border border-gray-300 rounded-s-lg p-2 h-11 focus:ring-gray-100 focus:ring-2 focus:outline-none">
